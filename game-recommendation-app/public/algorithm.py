...
def main(app_data):
    try:
        ...
        candidates = [
            ...
            {"name": "Call of Duty: Warzone", "genres": ["action", "shooter"], "tags": ["battle-royale", "military"], "metacritic": 79},
            {"name": "Tom Clancy's Rainbow Six Siege", "genres": ["action", "shooter"], "tags": ["tactical", "competitive"], "metacritic": 79},
            {"name": "Overwatch 2", "genres": ["action", "shooter"], "tags": ["hero-shooter", "team-based"], "metacritic": 79},
            {"name": "Marvel Rivals", "genres": ["action", "shooter"], "tags": ["hero-shooter", "superheroes"], "metacritic": 75},
            {"name": "Team Fortress 2", "genres": ["action", "shooter"], "tags": ["hero-shooter", "team-based"], "metacritic": 92},
            {"name": "Paladins", "genres": ["action", "shooter"], "tags": ["hero-shooter", "fantasy"], "metacritic": 78},
            ...
            {"name": "Spiritfarer", "genres": ["adventure", "simulation", "indie"], "tags": ["relaxing", "emotional"], "metacritic": 84},
            {"name": "A Little to the Left", "genres": ["puzzle", "indie"], "tags": ["relaxing", "cozy"], "metacritic": 77},
            {"name": "Assemble with Care", "genres": ["puzzle", "indie"], "tags": ["relaxing", "story-rich"], "metacritic": 72},
            {"name": "Coral Island", "genres": ["simulation", "rpg"], "tags": ["farming", "relaxing"], "metacritic": 82},
            {"name": "Disney Dreamlight Valley", "genres": ["simulation", "adventure"], "tags": ["relaxing", "life-sim"], "metacritic": 73},
            {"name": "My Time at Sandrock", "genres": ["rpg", "simulation"], "tags": ["crafting", "farming"], "metacritic": 81},
            {"name": "Story of Seasons", "genres": ["simulation", "rpg"], "tags": ["farming", "relaxing"], "metacritic": 76},
            {"name": "Sun Haven", "genres": ["rpg", "simulation"], "tags": ["farming", "fantasy"], "metacritic": 80},
            {"name": "The Sims 4", "genres": ["simulation"], "tags": ["life-sim", "creative"], "metacritic": 70},
            ...
            {"name": "Risk of Rain 2", "genres": ["action", "indie"], "tags": ["roguelike", "co-op"], "metacritic": 85},
            {"name": "Enter the Gungeon", "genres": ["action", "indie"], "tags": ["roguelike", "bullet-hell"], "metacritic": 84},
            {"name": "Monster Train", "genres": ["strategy", "indie"], "tags": ["deck-builder", "roguelike"], "metacritic": 86},
            {"name": "Inscryption", "genres": ["strategy", "indie"], "tags": ["deck-builder", "horror"], "metacritic": 85},
            {"name": "Wildfrost", "genres": ["strategy", "indie"], "tags": ["deck-builder", "roguelike"], "metacritic": 81},
            {"name": "Across the Obelisk", "genres": ["strategy", "rpg"], "tags": ["deck-builder", "co-op"], "metacritic": 78},
            ...
            {"name": "Nioh 2", "genres": ["action", "rpg"], "tags": ["difficult", "souls-like"], "metacritic": 85},
            {"name": "Remnant II", "genres": ["action", "rpg"], "tags": ["souls-like", "co-op"], "metacritic": 80},
            {"name": "The Witcher 3", "genres": ["rpg", "action"], "tags": ["open-world", "story-rich"], "metacritic": 92},
            {"name": "Monster Hunter: World", "genres": ["action", "rpg"], "tags": ["co-op", "boss-fights"], "metacritic": 90},
            {"name": "Dragon's Dogma 2", "genres": ["action", "rpg"], "tags": ["open-world", "fantasy"], "metacritic": 86},
            {"name": "Baldur's Gate 3", "genres": ["rpg", "strategy"], "tags": ["story-rich", "turn-based"], "metacritic": 96},
            {"name": "Divinity: Original Sin 2", "genres": ["rpg", "strategy"], "tags": ["turn-based", "co-op"], "metacritic": 93},
            {"name": "Disco Elysium", "genres": ["rpg", "adventure"], "tags": ["story-rich", "choices-matter"], "metacritic": 91},
            {"name": "Pillars of Eternity", "genres": ["rpg"], "tags": ["crpg", "story-rich"], "metacritic": 89},
            {"name": "Pathfinder: Wrath of the Righteous", "genres": ["rpg"], "tags": ["crpg", "fantasy"], "metacritic": 83},
            {"name": "Dragon Age: Origins", "genres": ["rpg"], "tags": ["story-rich", "fantasy"], "metacritic": 91},
            ...
            {"name": "The Elder Scrolls V: Skyrim", "genres": ["rpg", "action"], "tags": ["open-world", "fantasy"], "metacritic": 94},
            {"name": "Fallout 4", "genres": ["rpg", "action"], "tags": ["open-world", "post-apocalyptic"], "metacritic": 87},
            {"name": "Horizon Zero Dawn", "genres": ["action", "rpg"], "tags": ["open-world", "sci-fi"], "metacritic": 89},
            ...
            {"name": "Warcraft III", "genres": ["strategy"], "tags": ["rts", "fantasy"], "metacritic": 92},
            {"name": "Command & Conquer Remastered Collection", "genres": ["strategy"], "tags": ["rts", "classic"], "metacritic": 82},
            {"name": "Company of Heroes 2", "genres": ["strategy"], "tags": ["rts", "war"], "metacritic": 80},
            {"name": "Civilization VI", "genres": ["strategy"], "tags": ["4x", "turn-based"], "metacritic": 88},
            {"name": "Stellaris", "genres": ["strategy", "simulation"], "tags": ["4x", "space"], "metacritic": 78},
            {"name": "Crusader Kings III", "genres": ["strategy", "simulation"], "tags": ["grand-strategy", "medieval"], "metacritic": 91},
            {"name": "Hearts of Iron IV", "genres": ["strategy", "simulation"], "tags": ["grand-strategy", "war"], "metacritic": 83},
            {"name": "Endless Legend", "genres": ["strategy"], "tags": ["4x", "fantasy"], "metacritic": 82},
            {"name": "Humankind", "genres": ["strategy"], "tags": ["4x", "historical"], "metacritic": 77},
            {"name": "Risk: Global Domination", "genres": ["strategy"], "tags": ["board-game", "turn-based"], "metacritic": 70},
            ...
            {"name": "Need for Speed Heat", "genres": ["racing", "action"], "tags": ["cars", "arcade"], "metacritic": 72},
            {"name": "DiRT Rally 2.0", "genres": ["racing", "sports"], "tags": ["rally", "simulation"], "metacritic": 84},
            ...
            {"name": "Tony Hawk's Pro Skater 1 + 2", "genres": ["sports", "action"], "tags": ["skateboarding", "arcade"], "metacritic": 89},
            {"name": "PGA Tour 2K23", "genres": ["sports", "simulation"], "tags": ["golf", "realistic"], "metacritic": 77},
            ...
            {"name": "Outlast", "genres": ["horror", "adventure"], "tags": ["survival-horror", "first-person"], "metacritic": 80},
            ...
            {"name": "Valheim", "genres": ["survival", "sandbox"], "tags": ["crafting", "co-op"], "metacritic": 86},
            {"name": "Don't Starve Together", "genres": ["survival", "indie"], "tags": ["co-op", "crafting"], "metacritic": 83},
            ...
            {"name": "System Shock", "genres": ["action", "rpg"], "tags": ["sci-fi", "immersive-sim"], "metacritic": 78},
            {"name": "Deathloop", "genres": ["action", "shooter"], "tags": ["immersive-sim", "time-loop"], "metacritic": 88},
            {"name": "Metal Gear Solid V: The Phantom Pain", "genres": ["action", "stealth"], "tags": ["open-world", "tactical"], "metacritic": 93},
            {"name": "Tom Clancy's Splinter Cell: Blacklist", "genres": ["action", "stealth"], "tags": ["tactical", "espionage"], "metacritic": 82},
            {"name": "Thief", "genres": ["action", "stealth"], "tags": ["first-person", "dark"], "metacritic": 70},
            {"name": "Aragami", "genres": ["action", "stealth"], "tags": ["ninja", "indie"], "metacritic": 71},
            {"name": "Ori and the Blind Forest", "genres": ["platformer", "adventure"], "tags": ["metroidvania", "beautiful"], "metacritic": 88},
            {"name": "Hollow Knight", "genres": ["action", "platformer", "indie"], "tags": ["metroidvania", "difficult"], "metacritic": 90},
            {"name": "Celeste", "genres": ["platformer", "indie"], "tags": ["difficult", "story-rich"], "metacritic": 92},
            {"name": "Metroid Dread", "genres": ["action", "platformer"], "tags": ["metroidvania", "sci-fi"], "metacritic": 88},
            {"name": "Blasphemous", "genres": ["action", "platformer", "indie"], "tags": ["metroidvania", "dark-fantasy"], "metacritic": 77},
            {"name": "Cities: Skylines", "genres": ["simulation", "strategy"], "tags": ["city-builder", "management"], "metacritic": 85},
            {"name": "Planet Coaster", "genres": ["simulation", "strategy"], "tags": ["theme-park", "creative"], "metacritic": 83},
            {"name": "Satisfactory", "genres": ["simulation", "sandbox"], "tags": ["automation", "building"], "metacritic": 90},
            {"name": "Factorio", "genres": ["simulation", "strategy"], "tags": ["automation", "building"], "metacritic": 90},
            {"name": "Planet Zoo", "genres": ["simulation", "strategy"], "tags": ["management", "animals"], "metacritic": 81},
            {"name": "House Flipper", "genres": ["simulation", "casual"], "tags": ["relaxing", "building"], "metacritic": 68},
            {"name": "Youtubers Life", "genres": ["simulation", "casual"], "tags": ["life-sim", "management"], "metacritic": 63},
            {"name": "Jurassic World Evolution 2", "genres": ["simulation", "strategy"], "tags": ["management", "dinosaurs"], "metacritic": 80},
            {"name": "Two Point Hospital", "genres": ["simulation", "strategy"], "tags": ["management", "comedy"], "metacritic": 83},
            {"name": "Let's Build a Zoo", "genres": ["simulation", "strategy"], "tags": ["management", "animals"], "metacritic": 75},
            {"name": "Stray", "genres": ["adventure", "indie"], "tags": ["cats", "atmospheric"], "metacritic": 83},
            {"name": "My Child Lebensborn", "genres": ["simulation", "indie"], "tags": ["emotional", "story-rich"], "metacritic": 78},
            {"name": "My Child Lebensborn Remastered", "genres": ["simulation", "indie"], "tags": ["emotional", "story-rich"], "metacritic": 78},
            {"name": "What Remains of Edith Finch", "genres": ["adventure", "indie"], "tags": ["story-rich", "walking-sim"], "metacritic": 89},
            {"name": "LEGO Harry Potter: Years 1-4", "genres": ["action", "adventure"], "tags": ["lego", "family-friendly"], "metacritic": 79},
            {"name": "LEGO Harry Potter: Years 5-7", "genres": ["action", "adventure"], "tags": ["lego", "family-friendly"], "metacritic": 80},
            {"name": "LEGO Star Wars: The Skywalker Saga", "genres": ["action", "adventure"], "tags": ["lego", "family-friendly"], "metacritic": 82},
            {"name": "LEGO Marvel Super Heroes", "genres": ["action", "adventure"], "tags": ["lego", "superheroes"], "metacritic": 78},
            {"name": "Lethal Company", "genres": ["horror", "indie"], "tags": ["co-op", "party"], "metacritic": 82},
            {"name": "Content Warning", "genres": ["horror", "indie"], "tags": ["co-op", "party"], "metacritic": 75},
            {"name": "Among Us", "genres": ["party", "strategy"], "tags": ["social-deduction", "multiplayer"], "metacritic": 85},
            {"name": "Fall Guys", "genres": ["party", "platformer"], "tags": ["multiplayer", "casual"], "metacritic": 80},
            {"name": "Party Animals", "genres": ["party", "action"], "tags": ["multiplayer", "physics"], "metacritic": 76},
            {"name": "Overcooked 2", "genres": ["party", "simulation"], "tags": ["co-op", "chaotic"], "metacritic": 81},
            {"name": "Destiny 2", "genres": ["action", "shooter"], "tags": ["looter-shooter", "shared-world"], "metacritic": 85},
            {"name": "Warframe", "genres": ["action", "shooter"], "tags": ["looter-shooter", "co-op"], "metacritic": 69},
            {"name": "Tom Clancy's The Division 2", "genres": ["action", "shooter"], "tags": ["looter-shooter", "co-op"], "metacritic": 84},
            {"name": "Borderlands 3", "genres": ["action", "shooter", "rpg"], "tags": ["looter-shooter", "co-op"], "metacritic": 81},
            {"name": "The First Descendant", "genres": ["action", "shooter", "rpg"], "tags": ["looter-shooter", "co-op"], "metacritic": 57}
        ]
